                ...
                <div class="container ">
                    <div class="row">
                        <div class="col d-flex justify-content-center mb-4  ">
                            <img className='img-m shadow rounded' src={Minimalist} alt="" />
                        </div>
                    </div>
                    <div class="col intro ">
                            <h1 className='text-center'> Kebahagiaan tidak selalu bisa digunakan. Kebahagiaan datang dari apa yang anda lakukan
                            </h1>
                            <p className='text-center'>Kebahagiaan bisa anda dapatkan dengan berbelanja. Maka dari itu, Anda bisa berbelanja disini untuk mendapatkan kebahagiaan</p>
                            <div className='container justify-content-center d-flex'>
                            <button className='btn  text-center align-item-center btn-dark'  >
                    ...
                    <div class="row">
                        <div class="col btn-kerjasama">
                            ...
                            <button className='btn btn-dark '  >
                                <a className='text-decoration-none text-white intro-btn' href='#'>Let's get in touch!</a>
                            </button>
                        </div>
                        <div class="col">
                            <img className='img-komunitas shadow rounded' src={Komunitas} alt="" />
                        </div>
                    </div>
                </div>
            </section>
